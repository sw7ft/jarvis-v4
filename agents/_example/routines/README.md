...
- Always post results back to `#example.com` — don't fail silently
- Use a `while true; do ... sleep N; done` loop for repeating routines
- Stop a routine: `tmux send-keys -t example-com:main.2 "kill %<job#>" Enter`
